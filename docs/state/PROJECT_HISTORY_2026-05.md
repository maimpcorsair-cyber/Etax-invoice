# Project History Archive — 2026-05

Archived from `PROJECT_STATE.md` on 2026-05-16 to keep the active handoff file short for Codex/Claude. Use this file only when older detailed deploy history or prior decision context is needed.
