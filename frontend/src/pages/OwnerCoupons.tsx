        ...
        {filteredCoupons.map((coupon) => {
          ...
          <div key={coupon.id} className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <div className="flex items-start justify-between gap-3">
              ...
              <button onClick={() => toggleCoupon(coupon.id, coupon.active)} className={`inline-flex min-h-9 items-center gap-1 rounded-full px-2.5 py-1 text-xs font-semibold ${statusTone}`}>
