...
function SheetPreviewCard({
  ...
  tabs: Array<{
    id: string;
    label: string;
    columns: Array<{ key: string; label: string; type?: 'currency' | 'date' | 'link' | 'text' }>;
  ...
  const monthEndTabs = monthEnd
    ? [
        ...
        },
        {
          ...
          rows: monthEnd.tabs.missingDocs,
        },
        {
          id: 'projectSummary',
          ...
          rows: monthEnd.tabs.projectSummary,
        },
      ]
    : [];
