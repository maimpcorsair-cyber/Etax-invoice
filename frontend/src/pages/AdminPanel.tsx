...
import { Users, FileText, Building, Key, Server, CreditCard, Upload, CheckCircle, XCircle, Loader2, AlertTriangle, Save, Sparkles, FlaskConical, Lock, ArrowRight, ScrollText, Zap, MessageCircle, Link2, Unlink2, Copy, Check, Bell, Settings, BriefcaseBusiness, Mail, Trash2 } from 'lucide-react';
...
function EmailDomainTab({ isThai }: { isThai: boolean }) {
  const { token } = useAuthStore();
