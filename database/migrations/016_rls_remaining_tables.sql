...
--
-- Follows the same pattern as migrations 007–011.
...
-- purchase_invoices: direct companyId
...
-- expense_attachments: indirect via expense_items → expense_vouchers
...
-- line_user_links: indirect via users
...
-- Force RLS for all tables (same as 010_force_rls_tenant_tables.sql)
